...
Billing (effective June 2, 2026):
  ...
  - Previously billed at the full 20-minute session rate regardless of actual usage
  - Per-minute rate is the same; the change only lowers cost for short sessions
