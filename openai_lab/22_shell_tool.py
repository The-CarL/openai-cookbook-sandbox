...
Billing (updated Jun 2 2026):
  Containers are billed per minute with a 5-minute minimum (was: flat 20-min session rate).
  Same per-minute rate; shorter sessions are now cheaper.
