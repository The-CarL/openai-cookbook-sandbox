...
GPT-5.6 caching note: reads are 90% off (same as other families), but writes
cost 1.25x the uncached input rate — the calculate_cost() below uses standard
cached-read pricing only; add a write-cost term if tracking cache-fill events.
"""
...
# GPT-5.6: cache reads also 90% off; cache writes cost 1.25x input (not tracked here).
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; pricing cut July 30) — 1.05M context
    "gpt-5.6-sol":   {"input": 5.00, "output": 30.00, "cached_input": 0.50},
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00, "cached_input": 0.20},  # was $2.50/$15
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20,  "cached_input": 0.02},  # was $1/$6
    # GPT-5.5 (April 23, 2026) — 2x per-token price vs 5.4
