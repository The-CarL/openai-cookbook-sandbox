...
print()
print("GPT-5.5 caching: only EXTENDED (24h) prompt caching is supported — in-memory is not.")
print("June 2026 update: for non-ZDR orgs, 24h retention is now the DEFAULT for all")
print("models, so cached_tokens will populate without any extra setup. ZDR orgs still")
print("default to in_memory; pass prompt_cache_retention='24h' to opt in.")
