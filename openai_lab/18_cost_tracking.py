...
# Pricing per 1M tokens (verified August 3, 2026)
...
# GPT-5.6 caching: writes billed at 1.25x input (not the standard 10% read rule).
# cached_input below is a read estimate only; verify official docs for write costs.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; prices reflect July 30 cuts)
    # Sol: $5/$30/M. Fast mode: 2.5× speed at 2× price.
    # Terra: −20% July 30. Luna: −80% July 30.
