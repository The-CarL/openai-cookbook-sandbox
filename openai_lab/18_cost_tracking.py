...
# Pricing per 1M tokens (verified September 1, 2026)
...
# GPT-5.6 caching: cache WRITES billed at 1.25x input rate (unlike other families).
#   Cache READS remain at 10% of input. Minimum cache lifetime: 30 minutes.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026) — 1.05M context
    # Sol: promotional pricing ($4/$20) through Nov 21, 2026; standard is $5/$30.
    # Luna/Terra: July 30 price cuts (Luna -80%, Terra -20%).
    # Cache writes billed at 1.25x input rate — include in cost models for write-heavy flows.
    "gpt-5.6-sol":   {"input": 4.00, "output": 20.00, "cached_input": 0.40},
    "gpt-5.6":       {"input": 4.00, "output": 20.00, "cached_input": 0.40},  # alias for sol
