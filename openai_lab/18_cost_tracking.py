...
# Cached input reads: ~10% of standard input for all families.
# GPT-5.6 cache WRITES (unique): billed at 1.25× input rate — not tracked here.
# Long-context (>272K input) billed at 2× input / 1.5× output for the ENTIRE session:
#   5.5: $10/$45; 5.6-sol: $10/$45; 5.6-terra: $4/$18; 5.6-luna: $0.40/$1.80.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; July 30 cuts: Terra -20%, Luna -80%)
    # gpt-5.6 aliases gpt-5.6-sol.
