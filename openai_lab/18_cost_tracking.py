...
# Cached input is 10% of input rate for 4.1/5.4/5.5 families (reads; writes are free).
# GPT-5.6+: cache WRITES billed at 1.25x input rate; reads are still 10% of input.
# Long-context (>272K input): 2x input, 1.5x output for the ENTIRE session (5.5 and 5.6).
PRICING = {
    # GPT-5.6 family (July 9, 2026 GA; July 30 prices: Luna -80%, Terra -20% from launch)
    # Cache writes: 1.25x input rate. Cache reads: 10% of input. Explicit breakpoints only.
    ...
    # GPT-5.5 (April 23, 2026 flagship) — standard pricing for <=272K input sessions
