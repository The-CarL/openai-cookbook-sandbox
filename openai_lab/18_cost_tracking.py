...
# Cached input prices: 10% of standard input (cache reads) across all families.
# Cache writes: 1.25× standard input for GPT-5.6; no explicit write charge for older families.
# Long-context surcharge: sessions >272K input → 2× input and 1.5× output for the full session
# (applies to gpt-5.5 and all gpt-5.6 tiers).
PRICING = {
    # GPT-5.6 (GA July 9, 2026 — current generation)
    # Prices reflect post-July 30 cuts: Terra −20%, Luna −80%. Sol unchanged.
    ...
    # GPT-5.5 (April 23, 2026) — standard pricing applies to sessions <=272K input.
