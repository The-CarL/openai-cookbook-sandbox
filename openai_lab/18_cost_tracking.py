...
PRICING = {
    ...
    # GPT-4.1 family (cost-effective production)
...
print(f"\n--- Key insight: same prompt across model tiers ---")
...
if c4['total_cost'] > 0 and c2['total_cost'] > 0:
    print(f"\n  4.1 is {c4['total_cost']/c2['total_cost']:.1f}x more expensive than 4.1-mini")
    print(f"  5.4-mini is {c5['total_cost']/c2['total_cost']:.1f}x more expensive than 4.1-mini")
