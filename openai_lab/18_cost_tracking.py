...
# GPT-5.6 cache writes: billed at 1.25x uncached input (reads still 10% of input).
PRICING = {
    # GPT-5.6 family (GA July 9, 2026) — Sol/Terra/Luna capability tiers.
    # Cache reads: 10% of input (same 90%-off rule). Cache writes: 1.25x input.
    ...
    # GPT-5.5 (April 23, 2026) — standard pricing applies only to <=272K input sessions.
