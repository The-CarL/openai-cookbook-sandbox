...
# GPT-5.6 caching note: cache reads = 10% of input (same rule as other families).
# Explicit cache WRITES (new in 5.6) = 1.25× standard input rate; minimum 30-min lifetime.
PRICING = {
