...
# GPT-5.6: cache READS at 10% of input; cache WRITES at 1.25x input rate.
#   Sol promotional pricing ($4/$20) guaranteed through Nov 21, 2026; standard $5/$30.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026) — stronger reasoning, coding, cybersecurity
    # Cache writes billed at 1.25x input rate; 30-min minimum cache lifetime.
    "gpt-5.6-sol":   {"input": 4.00, "output": 20.00, "cached_input": 0.40},  # promo; std $5/$30
