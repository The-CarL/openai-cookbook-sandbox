...
# GPT-5.6: caching uses explicit breakpoints (30-min min, writes at 1.25x input rate),
# NOT the 10% rule — cached_input omitted; falls back to full input price as upper bound.
# GPT-5.6 prices reflect July 30, 2026 cuts (Luna -80%, Terra -20%).
PRICING = {
    # GPT-5.6 family (GA July 9; price cuts July 30, 2026)
