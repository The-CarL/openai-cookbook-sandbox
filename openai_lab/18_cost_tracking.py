...
# GPT-5.6 caching: reads at 10% of input (standard rule); writes at 1.25x input
# (new — billed in cache_write_tokens field). 30-min minimum cache lifetime.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026). Sol/Terra/Luna replace base/mini/nano.
