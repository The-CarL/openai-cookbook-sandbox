...
# GPT-5.6 caching differs: writes cost 1.25× input (billed separately, NOT in usage);
# cache read discount for 5.6 is not yet officially documented — using 10% as placeholder.
PRICING = {
    ...
    # GPT-5.6 family (GA July 9, 2026; Luna/Terra prices cut July 30)
    # Cache read placeholder at 10%; cache write surcharge (1.25× input) billed
    # separately by OpenAI and does NOT appear in usage.input_tokens_details.
