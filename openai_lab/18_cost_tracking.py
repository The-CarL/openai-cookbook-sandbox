...
# GPT-5.6: cache WRITES billed at 1.25x input rate (new behaviour vs prior families).
# Cache reads still use the 10% discount (same as prior families).
# GPT-5.6 Sol: promotional pricing ($4/$20) through Nov 21, 2026.
PRICING = {
