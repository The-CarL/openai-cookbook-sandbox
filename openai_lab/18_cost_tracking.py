...
# GPT-5.6 uses explicit cache breakpoints (30-min min); cache writes at 1.25x input.
# GPT-5.6 Sol: promotional pricing ($4/$20) valid at least through November 21, 2026.
PRICING = {
    # GPT-5.6 family (GA June 26, 2026) — price cuts Jul-Aug 2026
    "gpt-5.6-sol":  {"input": 4.00, "output": 20.00, "cached_input": 0.40},   # promo Aug 21
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00, "cached_input": 0.20},  # cut Jul 30
    "gpt-5.6-luna": {"input": 0.20, "output": 1.20, "cached_input": 0.02},    # cut Jul 30
