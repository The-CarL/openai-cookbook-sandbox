...
# GPT-5.6 explicit caching: cache WRITES cost 1.25x input; reads stay at 10%.
# Luna/Terra prices as of July 30, 2026 (cut from $1/$6 and $2.50/$15).
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; Luna/Terra prices cut July 30)
    # alias gpt-5.6 → sol. Fast mode for Sol: 2.5x speed at 2x price ($10/$60).
