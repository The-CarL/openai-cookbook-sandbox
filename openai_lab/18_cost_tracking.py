...
# GPT-5.6 uses explicit cache breakpoints (30-min minimum lifetime);
# cache WRITES are billed at 1.25x input rate (not free like older families).
# GPT-5.6 Sol promotional pricing ($4/$20) guaranteed through Nov 21, 2026.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; 1.05M context)
    # cached_input = 10% of input (reads); cache writes billed separately at 1.25x input
