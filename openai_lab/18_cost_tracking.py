...
# GPT-5.6+: cache WRITES cost 1.25x input rate; cache READS are 10% of input (standard).
# calculate_cost() below tracks read-side caching only; write costs require separate tracking.
PRICING = {
    # GPT-5.6 family (July 9, 2026 GA) — Luna/Terra/Sol capability tiers.
    # gpt-5.6 aliases to gpt-5.6-sol. Context: 1.05M tokens.
