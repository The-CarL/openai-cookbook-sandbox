...
# GPT-5.6 caching: cache READS discounted 90% (same as other families);
# cache WRITES billed at 1.25x input rate — a new charge not captured here.
# GPT-5.6 prices reflect the July 30, 2026 cut (Luna -80%, Terra -20%).
PRICING = {
    # GPT-5.6 family (GA July 9, 2026) — explicit breakpoint caching, 1.05M context
