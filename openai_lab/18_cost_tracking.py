...
# GPT-5.6: explicit cache breakpoints (30-min min lifetime); cache reads ~10% of input;
# cache writes billed at 1.25× input rate (NOT reflected here — writes are not in usage).
# GPT-5.6 Sol pricing is promotional (set Aug 21, 2026; was $5.00/$30.00).
PRICING = {
    # GPT-5.6 family (GA July 9, 2026 — 1M context, 128K output)
