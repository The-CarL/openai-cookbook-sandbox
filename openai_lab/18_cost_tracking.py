...
# Cached input prices follow the standard 10% rule for 4.1/5.4/5.5/5.6 families.
...
# GPT-5.6 Sol: promo pricing $4/$20 (cached $0.40) through Nov 21, 2026; std $5/$30/$0.50.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; 1.05M context)
    # Luna/Terra: permanent price cuts July 30. Sol: promo through Nov 21, 2026.
