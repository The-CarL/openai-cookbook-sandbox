...
# GPT-5.6 NEW: cache WRITES cost 1.25x the input rate (see exercise 35).
#   Track write cost separately via usage.input_tokens_details.cache_write_tokens.
PRICING = {
    # GPT-5.6 family (GA July 9, 2026; prices after July 30 cuts)
    # Cache writes: 1.25x input; reads: 10% of input (same rule as 5.5).
    ...
    # GPT-5.5 (April 23, 2026) — 2x per-token price vs 5.4; cache writes free
