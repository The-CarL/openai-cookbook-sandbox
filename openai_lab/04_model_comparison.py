...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Sol/Terra/Luna replace base/mini/nano naming.
    # New: explicit cache breakpoints, 30-min min cache lifetime, cache writes at 1.25x input.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 21, 2026)
...
# GPT-5.6 cache writes: 1.25x input rate (new); cache reads: 10% of input rate.
PRICING = {
...
print("  5.4:   Still strong; cheaper per-token than 5.5/5.6 — cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4 for most tasks.")
print("  Long-context gotcha: sessions >272K input tokens billed at $10.00/$45.00/1M.")
print()
print("GPT-5.6 family (GA July 9, 2026) — Sol/Terra/Luna naming replaces base/mini/nano:")
print("  luna:  $1/$6/1M. High-volume, latency-sensitive workloads. Replaces 5.4-mini tier.")
print("  terra: $2.50/$15/1M. Balanced everyday work competitive with GPT-5.5.")
print("  sol:   $5/$30/1M. Frontier capability — SotA on coding, cybersecurity, science.")
print("  New caching: explicit breakpoints, 30-min min lifetime, writes at 1.25x input rate.")
