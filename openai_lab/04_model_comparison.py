...
MODELS = [
    ...
    # Explicit cache breakpoints; cache writes billed at 1.25x input rate.
    # Sol promotional rate ($4/$20) guaranteed through Nov 21, 2026.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 29, 2026)
...
# GPT-5.6 Sol: Aug 21 cut from $5/$30 → $4/$20 (promotional through Nov 21, 2026).
# GPT-5.6 Terra/Luna: Jul 30 cut (Terra 20%, Luna 80%).
PRICING = {
...
print("  mini:  Solid agentic default; cheaper than 5.6-terra.")
print("  5.4:   Still strong; cheaper per-token than 5.5 — keep for cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  Token-efficient vs 5.4; often cheaper end-to-end. Still a sound default")
print("  for workloads that predate 5.6 GA.")
...
print("  luna:  $0.20/$1.20/M — budget tier. Replaces 5.4-nano for cost-sensitive tasks.")
print("  terra: $2.00/$12.00/M — balanced. Comparable quality to 5.5 at lower cost.")
print("  sol:   $4.00/$20.00/M — strongest reasoning/coding (promotional through Nov 21, 2026).")
print("  Cache: explicit breakpoints, 30-min minimum lifetime, writes at 1.25x input rate.")
