...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — broadly available July 30, 2026. Three tiers:
    #   Sol: highest quality, strong reasoning and coding
...
# GPT-5.6 caching: different mechanism — uses explicit cache breakpoints with
# 30-min minimum cache lifetime; cache WRITES billed at 1.25x input rate.
PRICING = {
...
print("  mini:  The default for most agentic workloads if 5.6-luna is too weak.")
print("  5.4:   Cheaper per-token than 5.5/5.6-sol; computer use, image gen.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4 for most tasks, often cheaper end-to-end.")
