...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Stronger reasoning, coding, and cybersecurity.
    # Explicit cache breakpoints, 30-min minimum cache lifetime, writes billed at 1.25x input.
    # Luna/Terra prices cut July 30; Sol promotional price (~$4/$20) active through Nov 21, 2026.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified September 14, 2026)
...
# GPT-5.6-sol: standard $5.00/$30.00; promotional $4.00/$20.00 through Nov 21, 2026.
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # cut -80% on Jul 30
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # cut -20% on Jul 30
    "gpt-5.6-sol":   {"input": 5.00, "output": 30.00},  # standard; promo $4/$20 through Nov 21
}
...
print("  More token-efficient than 5.4 for most tasks. Default choice for mid-tier quality.")
...
print("  luna:  $0.20/$1.20 per 1M (cut -80% Jul 30). Budget tier, replaces 5.4-nano for most tasks.")
print("  terra: $2.00/$12.00 per 1M (cut -20% Jul 30). Balanced workhorse for everyday agentic use.")
print("  sol:   $5.00/$30.00 standard; $4.00/$20.00 promotional through Nov 21, 2026.")
print("         New flagship. Cache breakpoints (30-min min lifetime, writes at 1.25x input rate).")
