...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-6 Astra — GA September 3, 2026. Next-generation flagship.
    # 1.05M context; $10/$50/M; long-context (>272K) billed at 2x input / 1.5x output.
    # Cache: reads $1/M (10%), writes $12.50/M (1.25× input).
    "gpt-6-astra",
]

# Pricing per 1M tokens (verified September 10, 2026)
# GPT-5.5/6.x long-context (>272K tokens): 2x input + 1.5x output for FULL session.
PRICING = {
...
print("  mini:  Solid for agentic workloads where 5.5+ is overkill.")
print("  5.4:   Still strong; cheaper per-token than 5.5 — keep for cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  Token-efficient flagship before 5.6 and 6.x. Superseded by gpt-6-astra for")
print("  top-quality work. Long-context (>272K) billed at $10/$45/M for full session.")
print()
print("GPT-6 Astra (GA September 3, 2026) — current flagship:")
print("  Next-generation model for advanced analysis, coding, deep research, and")
print("  long-horizon agentic tasks. 1.05M context. $10/$50/M standard.")
print("  Long-context (>272K) billed at 2x input / 1.5x output for full request.")
print("  Cache reads: $1/M (10%); cache writes: $12.50/M (1.25× input).")
