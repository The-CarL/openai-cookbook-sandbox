...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026 (token-efficient, ~2x per-token vs 5.4)
    "gpt-5.5",
    # GPT-5.6 family — broadly available July 9, 2026. New flagship tier.
    # Stronger reasoning, coding, and cybersecurity vs 5.5. 1.05M context.
    # Long-context (>272K input): Sol $10/$45, Terra $5/$22.50, Luna $2/$9 per 1M.
    # Cache reads: 10% of input. Cache writes (explicit breakpoints): 1.25x input.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 26, 2026)
# GPT-5.5/5.6 long-context: sessions >272K input tokens billed at 2x input /
# 1.5x output for the ENTIRE session (see per-model comments above for rates).
PRICING = {
...
print("  mini:  Solid default for agentic workloads; cheaper than 5.5/5.6.")
print("  5.4:   Cost-sensitive flows where 5.5/5.6 quality isn't required.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  Token-efficient; often cheaper end-to-end than 5.4 despite 2x per-token price.")
...
print()
print("GPT-5.6 family (July 9, 2026 — current flagship):")
print("  luna:  $1/$6/M. Fastest, cheapest 5.6. High-volume, latency-sensitive.")
print("  terra: $2.50/$15/M. Balanced everyday workloads.")
print("  sol:   $5/$30/M. New frontier model — strongest reasoning, coding, security.")
print("  All 5.6 models: 1.05M context, 128K max output.")
print("  Cache write cost (new): 1.25x input rate for explicit cache breakpoints.")
