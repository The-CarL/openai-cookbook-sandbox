...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — July 9, 2026 GA. Three tiers: luna < terra < sol.
    # Stronger reasoning/coding/cybersecurity vs 5.5. 1.05M context, 128K max output.
    # New: explicit cache breakpoints (writes billed at 1.25x input, reads at 10%).
    # gpt-5.6 (no suffix) is an alias for gpt-5.6-sol.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 24, 2026)
...
# GPT-5.6 cache writes: 1.25x input rate; cache reads: 10% of input rate.
PRICING = {
...
print("  even at 2x the per-token price. Long-context gotcha: sessions >272K input tokens")
print("  are billed at $10.00/$45.00 per 1M (2x/1.5x) for the full session.")
print()
print("GPT-5.6 family (July 9, 2026 GA — three tiers, 1.05M context):")
print("  luna:  $1/$6 per 1M. Budget agentic work; stronger than 5.4-mini on hard tasks.")
print("  terra: $2.50/$15 per 1M. Balanced: strong coding/reasoning, same price as gpt-5.4.")
print("  sol:   $5/$30 per 1M. 5.6 flagship — best coding, cybersecurity, complex reasoning.")
print("         Use gpt-5.6 (no suffix) as a convenience alias for sol.")
print("  Caching: writes billed at 1.25x input; reads at 10% input. Explicit cache")
print("  breakpoints let you control cache boundaries (30-min minimum lifetime).")
