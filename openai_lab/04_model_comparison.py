...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. 1.05M context. Sol/Terra/Luna replace base/mini/nano naming.
    # Terra ($2/$12) and Luna ($0.20/$1.20) prices were cut July 30; Sol ($5/$30) unchanged.
    "gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna",
]

# Pricing per 1M tokens (verified August 11, 2026)
...
# GPT-5.6 caching: writes billed at 1.25x input; reads at 10% of input.
PRICING = {
    ...
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # cut from $2.50/$15 on Jul 30
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # cut from $1.00/$6.00 on Jul 30
}
...
print("\n--- Relative to gpt-5.6-luna (cheapest current tier) ---")
base = next(r for r in results if r["model"] == "gpt-5.6-luna")
for r in results:
...
print("  Token-efficient vs 5.4 at 2x per-token price. Still a strong default.")
...
print("  sol:   $5/$30 per 1M — new top tier, same price as 5.5 but stronger reasoning.")
print("  terra: $2/$12 per 1M — balanced; 20% cheaper than 5.5 with comparable quality.")
print("  luna:  $0.20/$1.20 per 1M — cheapest 5.6; 80% price cut on Jul 30.")
print("  Caching: writes billed at 1.25x input; reads at 10% of input.")
print("  Alias 'gpt-5.6' routes to sol.")
