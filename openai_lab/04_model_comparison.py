...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026. Token-efficient vs 5.4 but ~2x per-token price.
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Prices cut July 30.
    # Luna: cheapest 5.6, great for bulk tasks at frontier quality.
    # Terra: balanced tier, replaces 5.5 as default for most agentic flows.
    # Sol: strongest on coding/cybersecurity/science; Sol Fast mode available.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 31, 2026)
...
# GPT-5.6 cache writes: 1.25x uncached input rate; cache reads: 10% of input.
# GPT-5.6 Sol Fast mode: $10.00/$60.00/M at 2.5x Standard speed.
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # 80% cut Jul 30 from $1/$6
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # 20% cut Jul 30 from $2.50/$15
    "gpt-5.6-sol":   {"input": 5.00, "output": 30.00},  # unchanged; Fast mode $10/$60
}
...
print("  mini:  The default for most agentic workloads (before 5.6 arrived).")
print("  5.4:   Cheaper per-token than 5.5 for cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4 for most tasks. Long-context gotcha:")
print("  sessions >272K input tokens billed at $10.00/$45.00 per 1M (2x/1.5x).")
print()
print("GPT-5.6 family (GA July 9, 2026; prices cut July 30):")
print("  luna:  $0.20/$1.20/M — 80% cheaper than launch pricing. Bulk tasks at frontier quality.")
print("  terra: $2.00/$12.00/M — 20% cut. Replaces 5.5 as the default for new flows.")
print("  sol:   $5.00/$30.00/M — Strongest on coding, cybersecurity, science.")
print("         Sol Fast mode: $10/$60/M, up to 2.5x faster than Standard.")
