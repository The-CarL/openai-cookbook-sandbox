...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026. More token-efficient than 5.4; often cheaper end-to-end.
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Three tiers: Luna (cheapest), Terra (balanced),
    # Sol (flagship). gpt-5.6 aliases Sol. July 30 price cut: Terra -20%, Luna -80%.
    # 1.05M context window. Cache writes billed at 1.25x input rate.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 19, 2026; GPT-5.6 reflects July 30 price cuts)
# Long-context sessions (>272K input) are billed at 2x input / 1.5x output for the
# ENTIRE session. GPT-5.6 Sol: $10/$45; Terra: $4/$18; Luna: $0.40/$1.80.
PRICING = {
    ...
    "gpt-5.6-luna":   {"input": 0.20,  "output": 1.20},   # post-Jul-30 cut (-80%)
    "gpt-5.6-terra":  {"input": 2.00,  "output": 12.00},  # post-Jul-30 cut (-20%)
    "gpt-5.6-sol":    {"input": 5.00,  "output": 30.00},  # unchanged; gpt-5.6 aliases this
}
...
print("  More token-efficient than 5.4; often cheaper end-to-end. Now superseded by 5.6.")
print()
print("GPT-5.6 family (GA July 9, 2026; July 30 price cuts: Terra -20%, Luna -80%):")
print("  luna:  $0.20/$1.20 per 1M. Fastest, cheapest 5.6 tier — best for high-volume.")
print("  terra: $2.00/$12.00 per 1M. Balanced; strong reasoning at manageable cost.")
print("  sol:   $5.00/$30.00 per 1M. Flagship; gpt-5.6 aliases this ID.")
print("  All tiers: 1.05M context, cache writes at 1.25× input rate.")
print("  Long-context (>272K): Sol $10/$45, Terra $4/$18, Luna $0.40/$1.80 per 1M.")
