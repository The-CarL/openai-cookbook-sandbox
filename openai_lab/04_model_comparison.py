...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026 flagship. Token-efficient, often cheaper end-to-end.
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Stronger reasoning, coding, and cybersecurity.
    # Introduces programmatic tool calling (model writes JavaScript to orchestrate tools).
    # Cache writes billed at 1.25x uncached input rate; 30-min minimum cache lifetime.
...
# GPT-5.6+: cache writes cost 1.25x the uncached input rate (reads still 90% off).
PRICING = {
...
print("  even at 2x the per-token price. Good choice when 5.6 isn't needed.")
...
print()
print("GPT-5.6 family (GA July 9, 2026):")
print("  luna:  $1/$6/M — fastest and most affordable. New default for high-volume.")
print("  terra: $2.50/$15/M — balanced; performance competitive with GPT-5.5.")
print("  sol:   $5/$30/M — frontier flagship. Programmatic tool calling, stronger")
print("         reasoning, coding, and cybersecurity benchmarks.")
print("  Caching note: cache writes billed at 1.25x uncached rate (30-min min lifetime).")
