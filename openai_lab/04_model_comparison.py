...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.5-instant — May 5, 2026. Low-latency variant, same pricing as 5.5.
    # Default ChatGPT model; reduced hallucinations in sensitive domains.
    "gpt-5.5-instant",
]
...
print("\n--- Relative to gpt-5.5-instant (current default) ---")
base = results[-1]  # gpt-5.5-instant
for r in results:
...
print()
print("GPT-5.5-instant (May 5, 2026):")
print("  Same pricing as 5.5. Low-latency variant; reduced hallucinations in law,")
print("  medicine, and finance. Default ChatGPT model as of May 5, 2026.")
