...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026. Token-efficient flagship; ~2x per-token vs 5.4
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. 1.05M context, 128K max output.
    # Luna/Terra prices cut Jul 30 (80%/20% respectively); Sol unchanged.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 17, 2026)
...
# GPT-5.6 Terra and Luna prices reflect the July 30, 2026 reduction.
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # post-Jul-30 cut
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # post-Jul-30 cut
    "gpt-5.6-sol":   {"input": 5.00, "output": 30.00},  # unchanged from launch
}
...
print("  luna:  $0.20/$1.20 (post-Jul-30 80% cut). Fastest, cheapest. High-volume routing.")
print("  terra: $2.00/$12.00 (post-Jul-30 20% cut). Balanced everyday production workloads.")
print("  sol:   $5.00/$30.00. Flagship; same per-token price as gpt-5.5 but stronger")
print("         reasoning + coding. Use gpt-5.6 as the alias for Sol.")
print("  Caching: 10% of standard input rate across the family.")
