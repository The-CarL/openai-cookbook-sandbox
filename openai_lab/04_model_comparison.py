...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Three tiers: Luna (cheapest) → Terra → Sol.
    # New: programmatic tool calling, persisted reasoning, multi-agent beta.
    # Cache writes billed at 1.25× input; reads at ~10% (same as prior gen).
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 12, 2026)
...
# GPT-5.6 cache writes: billed at 1.25× uncached input rate; 30-min min lifetime.
PRICING = {
...
print("  mini:  Strong default for agentic workloads; still supported.")
print("  5.4:   Cheaper per-token than 5.5/5.6 — keep for cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4; 2x per-token. Long-context gotcha:")
print("  sessions >272K input tokens billed at $10/$45 per 1M for the full session.")
print()
print("GPT-5.6 family (GA July 9, 2026) — new features: programmatic tool calling,")
print("  persisted reasoning (reasoning.context), multi-agent orchestration beta.")
print("  Cache writes at 1.25× input; 30-min minimum cache lifetime.")
print("  luna:  $1/$6 per 1M — fastest and cheapest. Good for high-volume tasks.")
print("  terra: $2.50/$15 — GPT-5.5-level quality at half the Sol price.")
print("  sol:   $5/$30 — flagship; gpt-5.6 alias routes here. Best on hard tasks.")
