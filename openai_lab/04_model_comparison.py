...
MODELS = [
    ...
    # Cache writes billed at 1.25x input; reads still 90% off (30-min min lifetime)
...
print("  luna:  $1/$6/M. Fastest and cheapest. Daily tasks, fast extraction.")
print("  terra: $2.50/$15/M. Balanced default. Matches GPT-5.5 quality at same price.")
print("  sol:   $5/$30/M. Flagship. Complex reasoning, long agentic work.")
print("  Cache writes: 1.25x input rate (reads still 90% off). 30-min min lifetime.")
