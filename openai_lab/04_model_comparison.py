...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026; price cut July 30 (Luna -80%, Terra -20%).
    # Three tiers share a 1M-token context. Cache writes billed at 1.25x input rate;
    # 30-min minimum cache lifetime (explicit breakpoints only).
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified Aug 28, 2026)
...
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20,  "output": 1.20},   # -80% Jul 30
    "gpt-5.6-terra": {"input": 2.00,  "output": 12.00},  # -20% Jul 30
...
print()
print("GPT-5.6 family (GA July 9, 2026; price cut July 30):")
print("  luna:  $0.20/$1.20/M — budget 5.6, cut 80% on Jul 30. Fastest tier.")
print("  terra: $2.00/$12.00/M — balanced 5.6, cut 20% on Jul 30.")
print("  sol:   $5.00/$30.00/M — flagship 5.6. Best reasoning, coding, cybersec.")
print("  All three: 1M context. Cache writes billed at 1.25x input (30-min lifetime).")
