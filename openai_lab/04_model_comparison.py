...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Price cuts July 30: Luna -80%, Terra -20%.
    # Caching uses explicit breakpoints (30-min min, writes at 1.25x input), not 10% rule.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 8, 2026)
...
# GPT-5.6 Luna/Terra prices reflect the July 30, 2026 cuts (Luna -80%, Terra -20%).
PRICING = {
...
print()
print("GPT-5.6 family (GA July 9, 2026; price cuts July 30):")
print("  luna:  $0.20/$1.20/M — fastest/cheapest; high-volume workloads.")
print("  terra: $2.00/$12.00/M — balanced everyday model (cut 20% Jul 30).")
print("  sol:   $5.00/$30.00/M — flagship; strongest reasoning, coding, agentic work.")
print("  Caching: explicit breakpoints, 30-min minimum, writes at 1.25x input rate.")
print("  Fast mode (service_tier='fast'): sol at 2.5x speed, 2x price ($10/$60/M).")
