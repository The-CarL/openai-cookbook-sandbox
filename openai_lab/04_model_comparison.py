...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — July 9, 2026. Three-tier successor to 5.5.
    # Cache writes billed at 1.25x input (new); cache reads remain at 10%.
...
# GPT-5.6+: cache WRITES billed at 1.25x uncached input; cache reads at 10%.
PRICING = {
...
print("  mini:  The default for most agentic workloads before 5.6.")
print("  5.4:   Cheaper per-token than 5.5/5.6 — keep for cost-sensitive flows.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4; often cheaper end-to-end at 2x per-token.")
...
print("  luna:  $1/$6/M.  High-volume everyday tasks. Lightest, fastest tier.")
print("  terra: $2.50/$15/M. Premium production. Roughly gpt-5.5 quality at half the price.")
print("  sol:   $5/$30/M. Hardest reasoning, coding, cybersecurity, agentic tasks.")
print("  Cache writes billed at 1.25x input for all 5.6 models (new — see ex. 35).")
print("  Migration: gpt-5.6-terra is the straight upgrade for most gpt-5.5 workloads.")
