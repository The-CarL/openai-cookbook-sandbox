...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. 1M context, 128K output, explicit cache breakpoints.
    # Luna = cheapest; Terra = balanced; Sol = flagship. Pricing as of Aug 21, 2026.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified September 11, 2026)
...
# GPT-5.6 Sol pricing is a promotional 3-month rate (set Aug 21, 2026; was $5.00/$30.00).
# GPT-5.6 Luna/Terra pricing was cut Jul 30, 2026 (Luna -80%, Terra -20%).
PRICING = {
...
print("  mini:  The default for most agentic workloads; now often replaced by 5.6-luna.")
print("  5.4:   Still capable; cheaper per-token than 5.6 for non-reasoning tasks.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  Token-efficient for most tasks. Long-context gotcha: sessions >272K input")
print("  tokens are billed at $10.00/$45.00 per 1M for the full session.")
print()
print("GPT-5.6 family (GA July 9, 2026 — 1M context, 128K output):")
print("  luna:  $0.20/$1.20 — cheapest tier; replaces 5.4-mini for budget agentic work.")
print("  terra: $2.00/$12.00 — balanced quality and cost.")
print("  sol:   $4.00/$20.00 — current flagship (promotional rate through ~Nov 2026).")
print("  Cache note: GPT-5.6 uses explicit cache breakpoints (30-min min lifetime).")
print("  Cache writes are billed at 1.25× the input rate; reads at ~10% of input.")
