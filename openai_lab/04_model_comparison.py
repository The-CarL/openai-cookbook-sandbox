...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Three tiers: Sol (flagship), Terra (balanced),
    # Luna (fastest/cheapest). Context: 1.05M tokens. Cache writes billed at 1.25x input.
...
# GPT-5.6 Sol: promotional pricing ($4/$20) through Nov 21, 2026; standard is $5/$30.
# GPT-5.6 caching: cache writes billed at 1.25x input rate, 30-min minimum lifetime.
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # Jul 30 cut (-80%)
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # Jul 30 cut (-20%)
...
print()
print("GPT-5.6 family (GA July 9, 2026) — 1.05M context across all tiers:")
print("  luna:  $0.20/$1.20 per 1M — fastest, cheapest. Same tier as 4.1-nano price.")
print("  terra: $2.00/$12.00 per 1M — balanced quality/cost.")
print("  sol:   $4.00/$20.00 per 1M — flagship (promotional through Nov 21, 2026).")
print("  Caching gotcha: cache writes billed at 1.25x input rate (vs 0x on other families).")
print("  Use 'gpt-5.6' as an alias for gpt-5.6-sol.")
