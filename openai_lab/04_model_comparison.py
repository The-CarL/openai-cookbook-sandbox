...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Three durable capability tiers.
    # Luna ($1/$6): high-volume, latency-sensitive. Terra ($2.50/$15): balanced,
    # competitive with gpt-5.5 at half the price. Sol ($5/$30): frontier flagship.
    # New: explicit cache breakpoints (30-min min cache life, writes at 1.25x input).
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 18, 2026)
...
# GPT-5.6: cache writes billed at 1.25x input rate (new); reads at 10% (standard).
PRICING = {
...
print("  mini:  Previously the default for new agentic workloads.")
print("  5.4:   Still strong; cheaper per-token than 5.5.")
print()
...
print("  luna:  $1/$6/M. High-volume, latency-sensitive, best unit economics.")
print("  terra: $2.50/$15/M. Balanced; competitive with 5.5 at roughly half the price.")
print("  sol:   $5/$30/M. Frontier flagship. Use gpt-5.6 alias to auto-route to Sol.")
print("  Cache: explicit breakpoints (30-min min lifetime); writes billed at 1.25x input.")
