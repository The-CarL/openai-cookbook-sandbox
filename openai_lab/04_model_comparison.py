...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. 1.05M context, stronger reasoning/coding.
    # Luna/Terra: permanent price cuts July 30. Sol: promo through Nov 21, 2026 (std $5/$30).
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 23, 2026)
...
# GPT-5.6 Sol: promo pricing $4/$20 through Nov 21, 2026 (standard $5/$30).
PRICING = {
    ...
    "gpt-5.6-luna":  {"input": 0.20, "output": 1.20},   # permanent cut July 30 (was $1/$6)
    "gpt-5.6-terra": {"input": 2.00, "output": 12.00},  # permanent cut July 30 (was $2.50/$15)
    "gpt-5.6-sol":   {"input": 4.00, "output": 20.00},  # promo through Nov 21, 2026 (std $5/$30)
}
...
print("  even at 2x the per-token price. Still a solid default for high-quality flows.")
...
print()
print("GPT-5.6 family (GA July 9, 2026) — 1.05M context, stronger reasoning/coding:")
print("  luna:  $0.20/$1.20 per 1M. Fastest and cheapest; free tier default Aug 2026.")
print("         Same price as 4.1-nano — use it for high-volume work that needs reasoning.")
print("  terra: $2.00/$12.00 per 1M. Balanced; competitive with 5.5 at 40% lower output cost.")
print("  sol:   $4.00/$20.00 per 1M promo (std $5/$30; promo valid through Nov 21, 2026).")
print("         Deepest reasoning. Sol Fast mode: ~2.5x faster at 2x the price.")
print("         Best-in-class for coding and cybersecurity tasks.")
