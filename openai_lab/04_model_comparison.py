...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — July 9, 2026 GA. New Sol/Terra/Luna naming replaces base/mini/nano.
    # Cache writes billed at 1.25x input; cache reads at 10% of input (same as prior families).
    # Luna/Terra prices cut July 30, 2026 (Luna -80%, Terra -20%).
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified August 15, 2026)
# Long-context billing (>272K input): 2x input, 1.5x output for the ENTIRE session.
# Applies to GPT-5.5 and GPT-5.6 families.
PRICING = {
    ...
    # GPT-5.6 — July 30, 2026 prices (Luna -80%, Terra -20% from launch)
...
print("  More token-efficient than 5.4 for most tasks. Still a valid choice.")
...
print()
print("GPT-5.6 family (July 9, 2026 GA — July 30 prices shown):")
print("  luna:  $0.20/$1.20 per 1M. Luna launched at $1/$6 then dropped 80% on Jul 30.")
print("         Replaces 4.1-nano and 5.4-nano for most cheap-tier workloads.")
print("  terra: $2.00/$12.00 per 1M (-20% from launch). Balanced everyday work.")
print("  sol:   $5.00/$30.00 per 1M. Deepest reasoning; same price as 5.5.")
print("  New caching model: cache writes cost 1.25x the input rate (was free in prior")
print("  families). Cache reads are still 10% of input. Use explicit breakpoints (ex. 35)")
print("  to control cache boundaries — in-memory caching unsupported.")
