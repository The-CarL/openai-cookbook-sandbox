...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. Current SOTA. Prices cut July 30.
    # Sol: top reasoning/coding/security. Fast mode: 2.5× speed at 2× price.
    # Terra: gpt-5.5-class quality at lower cost (−20% Jul 30).
    # Luna: routing and lightweight tasks (−80% Jul 30).
    "gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna",
]

# Pricing per 1M tokens (verified August 3, 2026; GPT-5.6 reflects July 30 cuts)
...
# GPT-5.6 caching: writes billed at 1.25x input; 30-min minimum cache lifetime.
PRICING = {
...
base = results[-1]  # gpt-5.6-luna; use sol for comparison below
...
print("  Token-efficient; often cheaper end-to-end than 5.4. Consider 5.6-terra")
print("  instead: same ballpark quality, lower price after the July 30 cut.")
...
print("  sol:   Current SOTA. Top reasoning, coding, security. Fast mode: 2.5x")
print("         speed at 2x price. Same per-token cost as gpt-5.5.")
print("  terra: $2/$12/M. gpt-5.5-class quality, lower price (−20% July 30).")
print("  luna:  $0.20/$1.20/M. Routing and lightweight tasks (−80% July 30).")
print("  Caching note: writes billed at 1.25x input; 30-min minimum cache lifetime.")
