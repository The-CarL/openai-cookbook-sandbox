...
MODELS = [
    ...
    # All three have 1M context, 128K max output, explicit cache breakpoints.
    # Cache writes: 1.25x input; cache reads: 10% input (30-min minimum cache life).
    # Long-context surcharge (>272K input): 2x input, 1.5x output for full session.
    # Sol pricing: promotional rate valid at least through Nov 21, 2026.
...
# GPT-5.6 cache writes billed at 1.25x input rate (unlike 5.5 and earlier).
PRICING = {
...
print("  More token-efficient than 5.4 for most tasks. Still a solid choice.")
print("  Long-context gotcha: sessions >272K input tokens are billed at")
print("  $10.00/$45.00 per 1M (2x/1.5x) for the full session.")
print()
print("GPT-5.6 family (GA July 9, 2026; Sol cut Aug 21, Terra/Luna cut July 30):")
print("  luna:  $0.20/$1.20 — fastest and cheapest; replaces 4.1-nano for hard tasks.")
print("  terra: $2.00/$12.00 — balanced; replaces 5.5 for most new flows.")
print("  sol:   $4.00/$20.00 — strongest reasoning, coding, cybersecurity (promo pricing).")
print("  5.6 caching: writes billed at 1.25x input; reads at 10% input.")
print("  Explicit cache breakpoints: place via prompt_cache_breakpoint; 30-min min lifetime.")
print("  Long-context gotcha: same 2x/1.5x surcharge above 272K input tokens as 5.5.")
