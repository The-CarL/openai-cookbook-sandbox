...
MODELS = [
    ...
    # GPT-5.5 — April 23, 2026. More token-efficient than 5.4; still a solid choice
    # for flows already tuned to it.
    "gpt-5.5",
    # GPT-5.6 family — GA July 9, 2026. New frontier. Three sub-models replace the
    # single-model pattern: Luna (fast/cheap), Terra (balanced), Sol (frontier).
    # Caching model changed: explicit breakpoints, 1.25x write rate, 30-min TTL.
    "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.6-sol",
]

# Pricing per 1M tokens (verified July 25, 2026)
...
# GPT-5.6 long-context meters: Sol $10/$45, Terra $5/$22.50, Luna $2/$9.
PRICING = {
...
print("\n--- Relative to gpt-5.6-sol (current frontier flagship) ---")
...
print("  mini:  Good default for agentic workloads; 5.6-terra now comparable.")
print("  5.4:   Still solid; cheaper per-token than 5.5/5.6.")
print()
print("GPT-5.5 (April 23, 2026):")
print("  More token-efficient than 5.4. Prefer 5.6-sol for new frontier work,")
print("  but keep 5.5 for flows already tuned to it.")
print("  Long-context gotcha: sessions >272K tokens → $10/$45 per 1M for full session.")
print()
print("GPT-5.6 family (GA July 9, 2026) — new frontier:")
print("  luna:  $1/$6/M. Fastest and cheapest. Cost-sensitive high-volume workloads.")
print("  terra: $2.50/$15/M. GPT-5.5-competitive at ~2× lower token price.")
print("  sol:   $5/$30/M. Frontier flagship; stronger reasoning, coding, cybersec.")
print("  Caching change: explicit breakpoints, 1.25x write rate, 30-min TTL.")
print("  Long-context: Sol $10/$45, Terra $5/$22.50, Luna $2/$9 for >272K input.")
