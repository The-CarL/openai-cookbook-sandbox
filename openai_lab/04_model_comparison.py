...
MODELS = [
    ...
    # Cache writes billed at 1.25× input (new vs earlier families); explicit breakpoints.
    # Jul 30 price cuts: Terra −20%, Luna −80%.
...
# GPT-5.6: cache writes billed at 1.25× input rate (see Exercise 25 for details).
PRICING = {
    ...
    "gpt-5.6-luna":   {"input": 0.20,  "output": 1.20},   # Jul 30: was $1/$6
    "gpt-5.6-terra":  {"input": 2.00,  "output": 12.00},  # Jul 30: was $2.50/$15
...
print()
print("GPT-5.6 family (GA July 9, 2026; Jul 30 price cuts):")
print("  luna:  $0.20/$1.20 — fastest, cheapest. Price cut 80% on Jul 30.")
print("  terra: $2.00/$12.00 — balanced. Price cut 20% on Jul 30.")
print("  sol:   $5.00/$30.00 — flagship. Strongest reasoning/coding/cybersecurity.")
print("  Cache gotcha: writes billed at 1.25x input rate; explicit breakpoints required.")
print("  Fast mode: sol only; service_tier='fast' → 2.5x speed at 2x price.")
