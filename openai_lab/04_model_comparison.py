...
MODELS = [
    ...
    "gpt-5.5",
    # GPT-5.6 family — GA June 26, 2026. Stronger reasoning/coding/cybersecurity.
    # All three tiers saw price cuts Jul-Aug 2026; Sol pricing is promotional.
...
# GPT-5.6 Sol: promotional $4/$20 rate valid at least through November 21, 2026.
PRICING = {
    ...
    "gpt-5.6-luna":   {"input": 0.20, "output": 1.20},   # 80% cut Jul 30 2026
    "gpt-5.6-terra":  {"input": 2.00, "output": 12.00},  # 20% cut Jul 30 2026
    "gpt-5.6-sol":    {"input": 4.00, "output": 20.00},  # promo cut Aug 21 2026
}
...
print("\n--- Relative to gpt-5.6-sol (current top 5.6 tier) ---")
...
print()
print("GPT-5.6 family (GA June 26, 2026 — stronger reasoning/coding/cybersecurity):")
print("  luna:  $0.20/$1.20 per 1M (80% cut Jul 30). Cheapest 5.6 tier.")
print("  terra: $2.00/$12.00 per 1M (20% cut Jul 30). Mid-tier 5.6.")
print("  sol:   $4.00/$20.00 per 1M promo (20%/33% cut Aug 21, valid >= Nov 21 2026).")
print("  All 5.6 models add explicit cache breakpoints (30-min min lifetime);")
print("  cache writes bill at 1.25x input rate.")
