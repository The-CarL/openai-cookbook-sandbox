...
agents via a persistent WebSocket session. Three models serve distinct jobs:
  ...
  gpt-realtime-2.1       — Updated July 6, 2026. Better alphanumeric recognition,
  ...
  gpt-realtime-2.1-mini  — Faster, lower-cost distilled reasoning variant (July 6, 2026).
                           Same pricing as gpt-realtime-2-mini.
                           Good default for cost-sensitive voice-agent workloads.
...
gpt-realtime-2.1          Full voice agent with GPT-5          Audio tokens
  (Jul 6, 2026)           reasoning, function calls,           (in ~$32/M,
                          ...
                          25% lower p95 latency than 2.0.

gpt-realtime-2.1-mini     Same as 2.1 but faster and          Same as
  (Jul 6, 2026)           lower-cost. Default for most        gpt-realtime-2-mini
...
When to use which:
  ...
  gpt-realtime-2.1-mini   — Same as above but optimized for cost/latency.
                            Preferred default for new voice-agent workloads.
