...
agents via a persistent WebSocket session. Current model lineup (Jul 2026):

  gpt-realtime-2.1       — Updated Jul 6, 2026. GPT-5-class reasoning for full
                           voice agents. Improved alphanumeric recognition,
                           silence/noise handling, and interruption behavior vs 2.0.
                           25%+ lower p95 latency. Billing: $32/M audio in, $64/M out.
  gpt-realtime-2.1-mini  — Faster, lower-cost reasoning model for voice agents.
                           Billing: $10/M audio in, $20/M audio out.
...
def summary():
    print("=" * 60)
    print("REALTIME MODEL COMPARISON (Jul 2026)")
    print("=" * 60)
    print("""
...
gpt-realtime-2.1        Full voice agent with GPT-5          Audio tokens
                        ...
                        interruption handling. Jul 6, 2026.  out $64/M)

gpt-realtime-2.1-mini   Faster, lower-cost voice agent.      Audio tokens
                        Distilled reasoning model.           (in $10/M,
                        Jul 6, 2026.                         out $20/M)
...
When to use which:
  ...
  gpt-realtime-2.1-mini  — Same use cases at lower cost; slightly less capable.
...
Prompt caching:
  ...
  Cached text: ~$0.40/M (10% of text input). Cached audio: ~$0.40/M.
