...
agents via a persistent WebSocket session. Three models serve distinct jobs:
  ...
  gpt-realtime-2.1       — Current flagship (released Jul 6, 2026). GPT-5-class
                           reasoning for full voice agents; base for ChatGPT
                           Advanced Voice. Billing: audio tokens (in ~$32/M, out ~$128/M).
...
DEPRECATION NOTICE (July 20, 2026):
  gpt-realtime-2 is deprecated — removal from the API on January 20, 2027.
  Migrate to gpt-realtime-2.1 (drop-in replacement, same WebSocket protocol).
...
async def example_1_text_convo():
    ...
    print("(gpt-realtime-2 deprecated Jul 20, 2026; removed Jan 20, 2027)")
    print()
...
gpt-realtime-2.1        Full voice agent with GPT-5          Audio tokens
                        ...
                        [Released Jul 6, 2026. Replaces
                        gpt-realtime-2 (deprecated Jul 20;
                        removed Jan 20, 2027)]
