...
| `gpt-5.4-mini` | 0.75 | 4.50 | 400K | Agentic workloads where 5.6-luna is too weak |
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24. Token-efficient; long-context gotcha >272K tokens |
...
### Caching gotchas
- Cached input is ~10% of standard input for 4.1/5.4/5.5 families.
...
- **GPT-5.6 uses breakpoint caching**: write cost is 1.25× input rate; 30-min guaranteed lifetime. See exercise 35.
