...
| 35 | Transcription models (Jul 2026) | `gpt-transcribe` / `gpt-live-transcribe`, hints, verbose JSON |
...
- **`gpt-transcribe` + `gpt-live-transcribe`** (Jul 28, 2026) — new STT defaults; gpt-transcribe halves whisper-1 WER, $0.0045/min; gpt-live-transcribe is low-latency streaming at $0.017/min. **Covered by ex. 35.**
