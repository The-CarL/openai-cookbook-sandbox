...
## Model lineup snapshot (verified July 31, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | — | **New flagship family (GA Jul 9).** Cheapest 5.6 tier; 80% price cut Jul 30. Best for bulk extraction/classification at frontier quality |
| `gpt-5.6-terra` | 2.00 | 12.00 | — | Balanced 5.6 tier; 20% price cut Jul 30. Replaces 5.5 as the mid-tier default |
| `gpt-5.6-sol` | 5.00 | 30.00 | — | 5.6 flagship; strongest on coding, cybersecurity, science. Sol Fast mode: $10/$60/M at 2.5× speed |
...
- **GPT-5.6 cache writes are billed at 1.25× the uncached input rate** (Sol $6.25/M, Terra $2.50/M, Luna $0.25/M). Cache reads retain the 90% discount. Minimum cache lifetime: 30 min.
...
- **GPT-5.6 family** (GA July 9, 2026; prices updated July 30) — Sol ($5/$30/M), Terra ($2/$12/M), Luna ($0.20/$1.20/M); Sol Fast mode ($10/$60/M, 2.5× speed). Model table above is current. Exercises 04 and 18 updated with 5.6 pricing. No standalone exercise yet — add one to cover cache-write billing and Sol Fast mode tradeoffs
