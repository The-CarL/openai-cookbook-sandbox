...
## Model lineup snapshot (verified August 18, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | Jul 9 GA. Fastest/cheapest 5.6. 80% price cut Jul 30 |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | Jul 9 GA. Balanced mid-tier. 20% price cut Jul 30 |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | Jul 9 GA. Current flagship for coding, research, cyber |
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($5/$30/M), Terra ($2/$12/M), Luna ($0.20/$1.20/M) after July 30 price cuts (Terra −20%, Luna −80%); 1.05M context, same >272K long-context surcharge; cache reads 10% of input, cache writes 1.25× input rate. Native multi-agent via `client.beta.responses` (beta). **Ultrafast** tier (Aug 13 preview, Cerebras, 750 tok/s, no pricing yet).
...
- **Astra** (announced Aug 1, 2026) — next major model family; solved 10 open math problems. Not yet in API — delayed for safety review (cyber capabilities). Unconfirmed — watching.
