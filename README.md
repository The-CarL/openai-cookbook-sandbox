...
- **`gpt-realtime-2`** (May 7) — Realtime API voice model with GPT-5-class reasoning; supersedes `gpt-realtime-1.5`. $32/1M audio input ($0.40 cached), $64/1M audio output
- **`gpt-realtime-translate`** (May 7) — Streaming speech-to-speech translation, 70+ input → 13 output languages. $0.034/min
- **`gpt-realtime-whisper`** (May 7) — Streaming speech-to-text with low-latency transcript deltas. $0.017/min
...
- **Realtime API** (GA as of May 7, 2026 — beta endpoint deprecated; see `gpt-realtime-2/translate/whisper` above for current model IDs)
