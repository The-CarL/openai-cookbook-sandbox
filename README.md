...
## Model lineup snapshot (verified July 10, 2026)
...
| `gpt-5.6-luna` | 1.00 | 6.00 | 1M | **GA Jul 9.** Fastest/cheapest 5.6 tier |
| `gpt-5.6-terra` | 2.50 | 15.00 | 1M | **GA Jul 9.** Balanced; same price as 5.4, newer capabilities |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1M | **GA Jul 9.** Strongest reasoning/coding/security. `gpt-5.6` alias → sol |
| `gpt-5.3-codex` | — | — | — | Feb 24: dedicated agentic coding model |
| `gpt-5.2-codex` | — | — | — | Jan 14: earlier codex generation |
| `o3` | 2.00 | 8.00 | — | Dedicated reasoning, complex proofs. **API deprecation Dec 11, 2026** |
...
- **GPT-5.6 cache billing change:** writes billed at 1.25× input rate; reads still 90% off. Explicit cache breakpoints, 30-min minimum cache lifetime.
...
- **GPT-5.6 family** (GA July 9, 2026) — `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`; pricing in model table above. New cache write billing (1.25× input) now in ex. 04 and 18. A dedicated exercise on explicit cache breakpoints would be ex. 35.
