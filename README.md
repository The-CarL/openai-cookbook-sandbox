...
## Model lineup snapshot (verified August 24, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship. Token-efficient → often cheaper end-to-end than 5.4 |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9, 2026. Fastest/cheapest 5.6 tier (80% cut Jul 30; was $1/$6) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9. Balanced everyday model (20% cut Jul 30; was $2.50/$15) |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | GA Jul 9. Top-tier quality. Explicit cache breakpoints, 30-min min cache |
| `gpt-5.3-codex` | — | — | — | Feb 24: dedicated agentic coding model |
| `gpt-5.2-codex` | — | — | — | Jan 14: earlier codex generation |
| `o3` | 2.00 | 8.00 | — | Dedicated reasoning, complex proofs (API snapshots deprecated Dec 11, 2026) |
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($5/$30/M standard), Terra ($2.00/$12/M after Jul-30 cut), Luna ($0.20/$1.20/M after Jul-30 cut); stronger reasoning, coding, and cybersecurity. Explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. Models now in lineup table above; no dedicated exercise yet
