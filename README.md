...
## Model lineup snapshot (verified September 7, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9. Cheapest 5.6 tier (80% price cut Jul 30) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9. Balanced; GPT-5.5-competitive at 2× lower cost (20% cut Jul 30) |
| `gpt-5.6-sol` | 4.00† | 20.00† | 1.05M | GA Jul 9. Frontier reasoning + agentic. †Promotional through Nov 21, 2026 (standard: $5/$30) |
...
- **GPT-5.6 cache write billing**: cache writes are billed at **1.25× the uncached input rate** (not free). Cache reads still get ~90% off. Budget for write cost on first-seen prompts.
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($4/$20/M promotional through Nov 21; standard $5/$30), Terra ($2/$12), Luna ($0.20/$1.20); stronger reasoning, coding, and cybersecurity. Explicit cache breakpoints; cache writes billed at 1.25× input. Added to model lineup table above. Consider adding a dedicated exercise (35) covering the Sol→Terra→Luna tier selection and cache-breakpoint API
