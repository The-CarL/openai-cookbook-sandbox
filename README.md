...
| 04 | Model comparison (4.1 / 5.4 / 5.5 / 6 Astra) | Cost vs latency vs quality picker |
...
## Model lineup snapshot (verified Sept 12, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship. Token-efficient; strong default until 6 Astra is needed |
...
| `gpt-6-astra` | 10.00 | 50.00 | 1M | Sep 3 flagship. Strongest alignment + intelligence; cyber features gated |
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($4/$20 promo thru Nov 21, std $5/$30), Terra ($2/$12), Luna ($0.20/$1.20); 1.05M context; new cache-write billing at 1.25× uncached rate
- **GPT-6 Astra extended capabilities** (Sep 3, 2026) — gpt-6-astra ($10/$50/M, cached $1/M, 1M ctx); computer use, browsing, SE tasks; cyber-sensitive features in trusted-access program. New exercise opportunity: ex. 35
- **Assistants API** — **shut down August 26, 2026**. Migrate to Responses API + Conversations API
