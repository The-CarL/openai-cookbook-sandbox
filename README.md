...
- **`gpt-realtime-2`** (May 7) — GPT-5-class reasoning voice model; 128K context, adjustable reasoning effort; $32/1M audio-in, $64/1M audio-out; replaces `gpt-realtime-1.5`
- **`gpt-realtime-translate`** (May 7) — live multilingual speech, 70+ input languages, 13 output languages; $0.034/min
- **`gpt-realtime-whisper`** (May 7) — streaming low-latency speech-to-text; $0.017/min
- **`gpt-audio-1.5`** (Feb 23) — Chat Completions audio model
- **WebSocket mode for Responses API** (Feb 23) — note: legacy Realtime API Beta deprecated May 12, 2026; new models use updated Realtime API
