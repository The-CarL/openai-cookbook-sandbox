...
## Model lineup snapshot (verified September 15, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24: superseded by 5.6 for most tasks |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | Ultra-budget 5.6; best cheap reasoning tier (GA Jul 9) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | Mid-tier 5.6; beats 5.5 quality at lower price |
| `gpt-5.6-sol` | 4.00* | 20.00* | 1.05M | High-quality default (GA Jul 9; *promo through Nov 21, std $5/$30) |
...
- GPT-5.6: cache *reads* at 10% of input; cache *writes* billed at **1.25× input rate**; 30-min minimum cache lifetime.
- Verify cache hits via `usage.input_tokens_details.cached_tokens` (Exercise 25).
...
- GPT-5.6 Sol promotional pricing ($4/$20/M) is guaranteed through November 21, 2026; standard rate is $5/$30/M.
...
- **GPT-5.6 family** (GA July 9, 2026; now in model table above) — Sol/Terra/Luna; stronger reasoning, coding, cybersecurity. Price cuts July 30 (Terra/Luna) and Aug 21 (Sol). Cache writes at 1.25× input rate, 30-min minimum cache lifetime.
