...
## Model lineup snapshot (verified August 11, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship. Token-efficient; superseded at top tier by gpt-5.6-sol |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | GA Jul 9 flagship. Explicit cache breakpoints (30-min min lifetime) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | Balanced 5.6 tier. Price cut Jul 30 (was $2.50/$15) |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | Cheapest 5.6. Price cut Jul 30 (was $1.00/$6.00) |
...
- **GPT-5.6 family** (GA July 9, 2026) — `gpt-5.6-sol` ($5/$30/M), `gpt-5.6-terra` ($2/$12/M post-Jul-30), `gpt-5.6-luna` ($0.20/$1.20/M post-Jul-30); stronger reasoning, coding, cybersecurity. Introduces explicit cache breakpoints (`prompt_cache_breakpoint`) with 30-min minimum lifetime; cache writes billed at 1.25× input, reads at 10% of input. Added to model lineup table and ex. 04/18 pricing. Alias `gpt-5.6` routes to Sol.
