...
## Model lineup snapshot (verified August 31, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1M | Cost-efficient high-volume workhorse (GA Jul 9; price cut Jul 30 −80%) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1M | Balanced mid-tier (GA Jul 9; price cut Jul 30 −20%) |
| `gpt-5.6-sol` | 4.00† | 20.00† | 1M | Current flagship (GA Jul 9). Best coding, reasoning, cybersecurity. `gpt-5.6` aliases Sol |
...
† GPT-5.6 Sol promotional pricing (≥20% cut, Aug 21) valid through Nov 21, 2026. Standard rates: $5.00/$30.00/M.
...
- **GPT-5.6 family** (GA July 9, 2026) — `gpt-5.6-sol` ($4/$20/M promo†; std $5/$30), `gpt-5.6-terra` ($2/$12/M), `gpt-5.6-luna` ($0.20/$1.20/M); stronger reasoning, coding, and cybersecurity. Introduces explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. `gpt-5.6` aliases Sol. Ultrafast tier (Cerebras, up to 750 tok/s, 14× Standard) in limited preview as of Aug 13 — no published pricing or GA date yet
