...
## Model lineup snapshot (verified July 9, 2026)
...
| `gpt-5.6-luna` | 1.00 | 6.00 | 1.05M | Jul 9 GA. Fastest/cheapest 5.6. Daily tasks, fast extraction |
| `gpt-5.6-terra` | 2.50 | 15.00 | 1.05M | Jul 9 GA. Balanced default. Matches GPT-5.5 quality, same price |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | Jul 9 GA. Flagship. Complex reasoning, long agentic work |
...
- **GPT-5.6 cache writes are billed at 1.25× the standard input rate** (cache reads still get the 90% discount). The minimum cache lifetime is 30 minutes.
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($5/$30/M), Terra ($2.50/$15/M), Luna ($1/$6/M); stronger reasoning, coding, and cybersecurity. Introduces explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. Model IDs: `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` (bare `gpt-5.6` routes to Sol). Added to model lineup table and pricing exercises.
