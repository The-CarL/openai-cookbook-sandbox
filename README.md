...
## Model lineup snapshot (verified August 27, 2026)
...
| `gpt-5.6-sol` | 4.00\* | 20.00\* | 1.05M | GA Jul 9. \*Promotional rate through Nov 21 2026 (standard $5/$30) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9. Balanced; Jul 30 cut from $2.50/$15 |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9. High-volume; Jul 30 cut 80% from $1/$6 |
...
- **GPT-5.6 Fast mode** (GA July 9) — Sol variant with 2.5× faster throughput at 2× Sol's price; Terra and Luna do not have a Fast mode yet
- **Programmatic Tool Calling** (GPT-5.6+) — model writes and runs in-memory programs that coordinate tool calls and process intermediate results; ZDR-compatible
