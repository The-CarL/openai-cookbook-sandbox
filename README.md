...
## Model lineup snapshot (verified August 23, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9. Fastest/cheapest 5.6. ChatGPT free-tier default Aug 2026 |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9. Balanced; competitive with 5.5 at lower output cost |
| `gpt-5.6-sol` | 4.00* | 20.00* | 1.05M | GA Jul 9. Deepest reasoning; coding/cybersecurity SOTA. *Promo through Nov 21, 2026 (std $5/$30) |
...
- **GPT-5.6 family** (GA July 9, 2026; 1.05M context) — Sol ($4/$20/M promo through Nov 21, 2026; std $5/$30/M), Terra ($2/$12/M, permanent cut July 30), Luna ($0.20/$1.20/M, permanent cut July 30); stronger reasoning, coding, and cybersecurity. Sol adds Fast mode (~2.5× faster at 2× price). Cache breakpoints: 30-min minimum lifetime; cache writes at 1.25× input rate. Pricing added to exercises 04 and 18; no dedicated exercise yet
