...
## Model lineup snapshot (verified August 12, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | — | GA Jul 9; cheapest 5.6 tier. Cache writes billed at 1.25× input |
| `gpt-5.6-terra` | 2.00 | 12.00 | — | GA Jul 9; balanced 5.6 tier. Explicit cache breakpoints |
| `gpt-5.6-sol` | 5.00 | 30.00 | — | GA Jul 9; 5.6 flagship. Stronger reasoning/coding/cybersecurity than 5.5 |
...
- **GPT-5.6 family** (GA July 9, 2026; Jul 30 price cuts) — model IDs `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`. Post-Jul-30 pricing: Sol $5/$30/M (unchanged), Terra $2/$12/M (−20%), Luna $0.20/$1.20/M (−80%). Cache reads: 90% off (same 10% rule). Cache writes: billed at 1.25× input rate (new vs 5.5). Explicit cache breakpoints, 30-min minimum TTL. Fast mode (`service_tier: "fast"`, formerly "priority"): Sol only, 2.5× faster at 2× price.
