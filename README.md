...
## Model lineup snapshot (verified August 29, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship. Token-efficient → still a solid default |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | Budget 5.6 tier (80% price cut Jul 30). Replaces 5.4-nano |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | Balanced 5.6 tier (20% cut Jul 30). Comparable to 5.5 |
| `gpt-5.6-sol` | 4.00 | 20.00 | 1.05M | Current flagship (GA Jul 9; promotional $4/$20 through Nov 21, 2026) |
...
### Caching gotchas
- Cached input is ~10% of standard input across the GPT-4.1/5.4/5.5/5.6 families.
...
- **GPT-5.6 cache writes are billed at 1.25× the input rate** (not free like older families). Explicit breakpoints required; minimum cache lifetime is 30 minutes.
...
- **GPT-5.6 caching mechanics** (GA July 9, 2026) — Models now in exercises 04 and 18. The new cache write billing (1.25× input rate, explicit breakpoints, 30-min min lifetime) differs enough from older families to warrant a dedicated exercise. Current pricing: Sol $4/$20/M (promotional through Nov 21), Terra $2/$12/M, Luna $0.20/$1.20/M
