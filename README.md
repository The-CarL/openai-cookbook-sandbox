...
| `gpt-5.6-luna` | 0.20 | 1.20 | — | GA Jun 26; cheapest 5.6 tier (80% price cut Jul 30) |
| `gpt-5.6-terra` | 2.00 | 12.00 | — | GA Jun 26; mid-tier 5.6 (20% price cut Jul 30) |
| `gpt-5.6-sol` | 4.00 | 20.00 | — | GA Jun 26; top 5.6 (20% promo cut Aug 21, valid ≥ Nov 21) |
...
- **GPT-5.6 family** (GA June 26, 2026) — Sol ($4/$20/M promo ≥ Nov 21), Terra ($2/$12/M), Luna ($0.20/$1.20/M); stronger reasoning, coding, and cybersecurity. Introduces explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. Price cuts: Luna −80% and Terra −20% on Jul 30; Sol −20% promo cut Aug 21
