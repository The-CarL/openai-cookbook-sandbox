...
## Model lineup snapshot (verified July 26, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24: token-efficient flagship. Long-context >272K: $10/$45 per 1M |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 1.00 | 6.00 | 1.05M | **Jul 9:** fastest/cheapest 5.6. Long-context >272K: $2/$9 |
| `gpt-5.6-terra` | 2.50 | 15.00 | 1.05M | **Jul 9:** balanced 5.6. Same price as 5.4 but stronger. Long-context >272K: $5/$22.50 |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | **Jul 9: current flagship.** Stronger reasoning, coding, cybersecurity. Long-context >272K: $10/$45 |
...
- **GPT-5.6 cache writes cost 1.25× the standard input rate** (explicit breakpoints, 30-min minimum cache lifetime). Cache reads remain 10% of input. See Exercise 25 for the general caching pattern.
...
- **GPT-5.6 family** (GA July 9, 2026) — now in the model lineup table above. Sol/Terra/Luna in production. Cache write mechanics (1.25× input rate) not yet in a dedicated exercise.
