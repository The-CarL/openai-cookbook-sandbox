...
## Model lineup snapshot (verified Aug 28, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1M | Budget 5.6 (GA Jul 9; -80% Jul 30). Fastest 5.6 tier |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1M | Balanced 5.6 (-20% Jul 30). Default for everyday 5.6 tasks |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1M | Flagship 5.6. Best reasoning, coding, cybersec |
...
- **GPT-5.6** uses explicit cache breakpoints with a 30-min minimum cache lifetime; cache *writes* are billed at 1.25× input rate (reads remain ~10% of standard).
...
- **GPT-5.6 family** (GA July 9, 2026; price cut July 30) — Sol ($5/$30/M), Terra ($2/$12/M, was $2.50/$15), Luna ($0.20/$1.20/M, was $1/$6, -80%); stronger reasoning, coding, and cybersecurity. Now in model lineup (exercises 04 and 18). **Ultrafast mode** for `gpt-5.6-sol` (up to 14× Standard speed, limited preview to select customers).
