...
## Model lineup snapshot (verified August 5, 2026)
...
| `gpt-5.6-luna` | 0.20 | 1.20 | 1M | GA Jul 9. Fastest, cheapest 5.6 tier (−80% vs preview) |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1M | GA Jul 9. Balanced capability/cost (−20% vs preview) |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1M | GA Jul 9. Deepest reasoning; bare `gpt-5.6` alias routes here |
...
- **GPT-5.6 family** — GA July 9, 2026. IDs: `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` (bare `gpt-5.6` → Sol). Prices as of July 30: Sol $5/$30/M (unchanged), Terra $2/$12/M (−20%), Luna $0.20/$1.20/M (−80%). Introduces explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. Fast mode for Sol: 2.5× throughput at 2× price
