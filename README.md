...
## Model lineup snapshot (verified August 25, 2026)
...
| `gpt-5.6-sol` | 5.00 † | 30.00 † | — | Jul 9 GA: top flagship. `gpt-5.6` alias routes here |
| `gpt-5.6-terra` | 2.00 | 12.00 | — | Jul 9 GA: balanced; default for new agentic workloads |
| `gpt-5.6-luna` | 0.20 | 1.20 | — | Jul 9 GA: cheapest. Use where 4.1-nano was the floor |
...
† GPT-5.6 Sol promotional pricing through Nov 21, 2026: $4.00 input / $20.00 output per 1M tokens.
...
- **GPT-5.6 family** (GA July 9, 2026) — model IDs: `gpt-5.6-sol` (alias `gpt-5.6`), `gpt-5.6-terra`, `gpt-5.6-luna`. Standard pricing: Sol $5/$30/M (promo $4/$20/M through Nov 21, 2026), Terra $2/$12/M (Jul 30: −20%), Luna $0.20/$1.20/M (Jul 30: −80%). Cache breakpoints with 30-min minimum; cache writes billed at 1.25× input. Fast mode for Sol: 2.5× faster at 2× price.
