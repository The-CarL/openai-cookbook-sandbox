...
| 33 | Realtime API v2 (May 2026, updated Jul 2026) | `gpt-realtime-2.1` / 2.1-mini / translate / whisper WebSocket voice agents |
...
- **gpt-realtime-2.1 / 2.1-mini** (July 6, 2026) — now covered in ex. 33. 25% lower p95 latency, better alphanumeric recognition and noise handling. 2.1-mini adds a 6× cheaper audio option for budget voice workloads. Audio output cost halved vs 2.0 ($64/M vs $128/M for 2.1).
