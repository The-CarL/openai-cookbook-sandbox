...
- **Realtime API** (GA as of May 12, 2026 — old beta endpoint retired)
  - **`gpt-realtime-2`** (May 7) — Speech-to-speech with GPT-5-class reasoning, 128K context; $32/$64 per 1M audio in/out tokens ($0.40 cached)
