...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship. Token-efficient; strong default until 5.6 is needed |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9. Fast/affordable 5.6 tier. Priced -80% from launch on Jul 30 |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9. Balanced everyday 5.6 tier. Priced -20% from launch on Jul 30 |
| `gpt-5.6-sol` | 4.00¹ | 20.00¹ | 1.05M | GA Jul 9. 5.6 flagship; ¹ promo through Nov 21, 2026 (std $5/$30) |
...
- **GPT-5.6+ cache writes** are billed at **1.25×** the uncached input rate (new). Cache reads remain 10% of uncached. GPT-5.6 supports explicit cache breakpoints with a 30-min minimum cache life.
