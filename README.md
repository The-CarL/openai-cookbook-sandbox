...
## Model lineup snapshot (verified September 13, 2026)
...
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24 flagship; still solid, explicit cache unsupported |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1M | GA Jul 9. Fastest/cheapest 5.6; replaces 4.1-nano for hard tasks |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1M | GA Jul 9. Balanced; replaces 5.5 for most new flows |
| `gpt-5.6-sol` | 4.00 | 20.00 | 1M | GA Jul 9. Strongest reasoning/coding/cybersecurity (promo pricing) |
...
- **GPT-5.6 introduces explicit cache breakpoints** (`prompt_cache_breakpoint`): 30-min minimum cache lifetime; cache **writes** billed at 1.25x input rate; cache **reads** at 10% input.
...
- **GPT-5.6 family** — GA July 9, 2026. Pricing after cuts (Sol Aug 21, Terra/Luna July 30): Sol $4/$20/M, Terra $2/$12/M, Luna $0.20/$1.20/M. Now covered in exercises 04 and 18. Explicit cache breakpoints, 1.25x write billing.
