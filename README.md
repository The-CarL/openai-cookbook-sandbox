...
- **gpt-realtime-2.1 / gpt-realtime-2.1-mini** (Jul 6, 2026) — Updated voice-agent models; better alphanumeric recognition, noise handling, and interruption behavior; p95 latency cut 25%. Output price halved vs gpt-realtime-2 ($64/M → was $128/M). Exercise 33 updated to use 2.1.
- **GPT Transcribe** (Jul 28, 2026) — Batch/file transcription model at $0.0045/min; replaces gpt-4o-transcribe (was $0.006/min). Supports free-form context, keyword hints, multi-language.
- **GPT Live Transcribe** (Jul 29, 2026) — Low-latency streaming transcription at $0.017/min; returns incremental transcript updates as audio arrives.
