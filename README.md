...
## Model lineup snapshot (verified May 12, 2026)
...
| `gpt-5.5-instant` | 5.00 | 30.00 | 1M | May 5: lower latency, reduced hallucination in law/medicine/finance |
...
- **Long-context surcharge (gpt-5.5 / gpt-5.5-instant):** prompts exceeding 272K input tokens are billed at 2× input and 1.5× output for the entire session.
