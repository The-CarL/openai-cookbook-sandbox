...
| `gpt-6-astra` | 10.00 | 50.00 | 1M | Sep 3 flagship. Advanced agents, computer use, browsing, science |
...
- **GPT-6 Astra** (Sep 3, 2026) — `gpt-6-astra`; $10/$50/M input/output, $1/M cached, 1M context, knowledge cutoff Apr 30 2026. Long-horizon agentic tasks (computer use, browsing, software engineering, science). Staged rollout; now in API. Worth a dedicated exercise (ex. 35 or 36).
