...
## Model lineup snapshot (verified September 3, 2026)
...
| `gpt-5.6-sol` | 4.00† | 20.00† | 1M | Jul 9 GA flagship; strongest reasoning/coding; 750 tok/s ultrafast tier |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1M | Balanced everyday model; same capability tier as 5.5 |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1M | High-volume budget; replaces 4.1-mini for many workloads |
| `gpt-5.3-codex` | — | — | — | Feb 24: dedicated agentic coding model |
| `gpt-5.2-codex` | — | — | — | Jan 14: earlier codex generation |
| `o3` | 2.00 | 8.00 | — | Dedicated reasoning; API deprecated Dec 11 2026 |
| `o4-mini` | 1.10 | 4.40 | — | Fast reasoning, math/code/visual |

† Sol: promotional pricing (cut Aug 21 from $5/$30); active through Nov 21, 2026.
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($4/$20/M†), Terra ($2/$12/M), Luna ($0.20/$1.20/M); 1M context, Feb 2026 knowledge cutoff. Introduces explicit cache breakpoints with 30-min minimum cache lifetime; cache writes billed at 1.25× input rate. Ultrafast tier for Sol via Cerebras (up to 750 tok/s). Two pricing cuts since launch: Luna –80% and Terra –20% on Jul 30; Sol –20%/–33% on Aug 21 (promotional through Nov 21)
