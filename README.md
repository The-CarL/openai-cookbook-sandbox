...
| 35 | Transcription models (Jul 2026) | `gpt-transcribe` (REST, $0.0045/min) + `gpt-live-transcribe` (streaming) |
...
- **`gpt-transcribe` / `gpt-live-transcribe`** (covered by ex. 35, Jul 28, 2026) — replaces gpt-4o-transcribe for new builds; $0.0045/min (async) and $0.017/min (streaming)
