...
## Model lineup snapshot (verified July 21, 2026)
...
| `gpt-5.6-luna` | 1.00 | 6.00 | — | GA Jul 9. Fast, cost-sensitive workloads (replaces 5.4-mini tier) |
| `gpt-5.6-terra` | 2.50 | 15.00 | — | GA Jul 9. Balanced everyday work, competitive with GPT-5.5 |
| `gpt-5.6-sol` | 5.00 | 30.00 | — | GA Jul 9. Frontier: coding, cybersecurity, science. SotA Jul 2026 |
...
### Caching gotchas
- Cached input is ~10% of standard input across GPT-4.1, 5.4, 5.5, and 5.6.
...
- **GPT-5.6 cache writes are billed at 1.25× input rate** (reported in `cache_write_tokens`). Minimum cache lifetime is 30 minutes. Cache reads are still 10% of input.
...
- **GPT-5.6 family** (GA July 9, 2026) — `gpt-5.6-sol` ($5/$30/M), `gpt-5.6-terra` ($2.50/$15/M), `gpt-5.6-luna` ($1/$6/M); SotA on coding, cybersecurity, and science. Explicit cache breakpoints, 30-min min cache lifetime, cache writes at 1.25× input rate. Added to model table and ex04/ex18. A dedicated exercise (35) for new caching primitives is a natural follow-up.
