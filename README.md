...
## Model lineup snapshot (verified July 18, 2026)
...
| `gpt-5.6-luna` | 1.00 | 6.00 | 1M | **GA Jul 9.** High-volume, latency-sensitive; best unit economics |
| `gpt-5.6-terra` | 2.50 | 15.00 | 1M | **GA Jul 9.** Balanced; competitive with 5.5 at half the price |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1M | **GA Jul 9.** Frontier flagship (`gpt-5.6` alias → Sol) |
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol ($5/$30/M), Terra ($2.50/$15/M), Luna ($1/$6/M); stronger reasoning, coding, and cybersecurity. Explicit cache breakpoints (30-min min lifetime); cache writes billed at 1.25× input rate. No waitlist — any API account can use it. Exercises 04 and 18 updated.
