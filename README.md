...
| `gpt-6-astra` | 10.00 | 50.00 | 1.05M | Sep 3 flagship. Recurrent-depth reasoning; 97.6% FrontierMath |
...
- **GPT-5.6 and GPT-6 Astra**: explicit cache breakpoints; cache **writes** billed at 1.25× input (5.6: $X×1.25, Astra: $12.50/M).
...
- **GPT-5.6 family** (GA July 9, 2026) — Sol, Terra, Luna. Post-cut pricing (Aug/Jul 2026): Sol $4/$20, Terra $2/$12, Luna $0.20/$1.20 per M. See ex. 04 and 18 for pricing details.
- **GPT-6 Astra** (GA Sep 3, 2026) — New flagship at $10/$50/M, 1.05M context. Cache writes $12.50/M (1.25× input), cached reads $1/M. Covered in ex. 04 and 18.
