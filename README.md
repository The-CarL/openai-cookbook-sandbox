...
## Model lineup snapshot (verified Aug 13, 2026)
...
| `gpt-5.4-mini` | 0.75 | 4.50 | 400K | Solid agentic workhorse. Tool search, computer, compaction |
| `gpt-5.4` | 2.50 | 15.00 | 1M | Computer use, image gen, native compaction |
| `gpt-5.4-pro` | — | — | 1M | March 5: computationally intensive problems |
| `gpt-5.5` | 5.00 | 30.00 | 1M | Apr 24. Token-efficient → often cheaper end-to-end than 5.4 |
| `gpt-5.5-pro` | 30.00 | 180.00 | 1M | Hardest reasoning, unchanged from 5.4 Pro pricing |
| `gpt-5.6-luna` | 0.20 | 1.20 | 1.05M | GA Jul 9; −80% Jul 30. Fastest/cheapest 5.6. High-volume agentic. |
| `gpt-5.6-terra` | 2.00 | 12.00 | 1.05M | GA Jul 9; −20% Jul 30. Balanced everyday work. |
| `gpt-5.6-sol` | 5.00 | 30.00 | 1.05M | GA Jul 9. Frontier reasoning/coding/cybersec. `gpt-5.6` aliases here. |
...
- **GPT-5.6 family** — GA July 9, 2026 (self-serve). Model IDs: `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` (`gpt-5.6` aliases to Sol). Prices after Jul 30 cuts: Sol $5/$30/M (unchanged), Terra $2/$12/M (−20%), Luna $0.20/$1.20/M (−80%). Long-context >922K: Sol $10/$45, Terra $4/$18, Luna $0.40/$1.80. Cache writes at 1.25× input; reads at 10%; 30-min minimum cache lifetime. Sol Fast mode: 2.5× speed at 2× price. Now in exercises 04 and 18.
- **GPT-5.6-Cyber** (Aug 10, 2026) — cybersecurity-specialist model built on Sol, trained for zero-day finding and exploit-chain construction. Lower refusal rate on dual-use security tasks. $12.50/$75/M. Requires Daybreak Red program vetting — not self-serve.
